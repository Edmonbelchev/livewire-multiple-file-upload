    ...
    document.addEventListener('livewire:initialized', function() {
        ...
        fileInput.addEventListener('change', function(event) {
            ...
            if (filesArray.length != formData.getAll('files[]').length) {
                ...
                component._startUpload(modelName, fileInfos, true)
            }
        });
            ...
            try {
                ...
                xhr.upload.onprogress = function(event) {
                    if (event.lengthComputable) {
                        const percentComplete = Number((event.loaded / event.total) * 100).toFixed(
                            2);
                ...
                xhr.onload = function() {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        ...
                        // Call next method
                        component._finishUpload(name, paths, true);
